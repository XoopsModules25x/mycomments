...
function news_useritems($uid, $limit=0, $offset=0)
{
    ...
    $sql = "SELECT storyid FROM ".$xoopsDB->prefix("mod_news_stories")." WHERE published>0 AND published<=".time()." AND uid=".$uid;
...
function news_iteminfo($items, $limit=0, $offset=0)
{
    ...
    FROM ".$xoopsDB->prefix("mod_news_stories")." s, ".$xoopsDB->prefix("mod_news_topics")." t
